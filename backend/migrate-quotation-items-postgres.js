 ...
 * - notes: Notas específicas del ítem cotizado
 * - has_invoice: Si el proveedor tiene factura para este ítem
 * - delivery_date: Fecha de entrega específica del ítem
 * - is_selected: Si el ítem está seleccionado para compra
 */
